...
export const contestants: Partial<DbContestant>[] = [
  ...
  },
  {
    ...
    bio: 'Amber is a vivacious single mother whose world revolves around her 13-year-old son. Currently, her typical Saturday night consists of dinner and board games with her son or soaking in the Jacuzzi with close friends. Amber finds it hard to date as a single mom, but now she is ready to focus on herself for the first time in a long time. When asked what her physical type is, Amber enthusiastically says "MATT JAMES!" She is looking for a man with whom to travel the world and eventually have more kids. She is caring, trustworthy and open-minded, but admittedly is also stubborn and a bit impatient. She says she is terrified of being on the edge of cliffs, but she is ready to take the leap head first into this once-in-a-lifetime adventure and hopefully return home with the man of her dreams by her side.',
    trivia: JSON.stringify([
